...
import { Copy, Send, Users, MessageSquare, LogOut } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
          ...
          {!connected ? (
            ...
            <div className="flex justify-center p-4">
              <div className="w-full max-w-6xl h-[90vh] bg-white dark:bg-gray-800 rounded-2xl shadow-lg flex">
                {/* Main Chat Area */}
                ...
                {showMembers && (
                  <div className="w-80 border-l border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                    <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                      <h3 className="font-medium text-gray-900 dark:text-white">Room Members</h3>
                      <p className="text-sm text-gray-500">{userCount} online</p>
                    </div>
